<<<<<<< HEAD:Project-Job Portal/Domain/Migrations/20251103142352_Test.cs
﻿using System;
    ...
    public partial class Test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nchar(25)", fixedLength: true, maxLength: 25, nullable: false),
                    Description = table.Column<string>(type: "nchar(25)", fixedLength: true, maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupMembers_MessageGroups_MessageGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeekerImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobProviderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interviews_CompanyUser_CompanyUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMembers_MessageGroupId",
                table: "GroupMembers",
...
//            migrationBuilder.DropTable(
//                name: "GroupMembers");
>>>>>>> 6959ce1bb84d1b7c1ba32b28f827057c8f121f75:Project-Job Portal/Domain/Migrations/20251029134446_first.cs
