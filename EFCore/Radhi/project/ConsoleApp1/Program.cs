...
public class program
{
    ...
    static void ViewStudents()
    {
        var context = new StudentAppDbContext();
        {
            ...
            {
                Console.WriteLine($"ID: {student.Student_Id}, Name: {student.Name}, Mobile: {student.Mobileno}");
            }
        }
    }
    ...
    static void AddMarks()
    {
        var context = new StudentAppDbContext();
        {
            ...
            var mark = new Mark { Student_Id = studentId, M1 = m1, M2 = m2, M3 = m3 };
    ...
    static void ViewMarks()
    {
        var context = new StudentAppDbContext();
        {
            ...
            {
                Console.WriteLine($"Mark ID: {mark.MarkId}, Student ID: {mark.Student_Id}, M1: {mark.M1}, M2: {mark.M2}, M3: {mark.M3}");
            }
        }
    }
}
